...
# Use deprecated demos utilities to keep tests scoped to deprecated APIs.
from codeflare_sdk.common.deprecated.utils.demos import copy_demo_nbs
...
class TestCopyDemoNbs:
    ...
    def test_copy_demo_nbs_overwrite_true(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with patch(
                "codeflare_sdk.common.deprecated.utils.demos.demo_dir", temp_dir
            ):
