...
# Use deprecated validation utilities to keep tests scoped to deprecated APIs.
from codeflare_sdk.common.deprecated.utils.validation import (
    extract_ray_version_from_image,
    validate_ray_version_compatibility,
)
from codeflare_sdk.common.deprecated.utils.constants import RAY_VERSION
