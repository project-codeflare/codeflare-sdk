...
# Use deprecated utils to keep tests scoped to deprecated APIs.
from codeflare_sdk.common.deprecated.utils.utils import (
    update_image,
    get_ray_image_for_python_version,
)
from codeflare_sdk.common.deprecated.utils.constants import (
