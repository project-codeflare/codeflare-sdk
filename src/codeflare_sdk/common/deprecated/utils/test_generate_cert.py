...
# Use deprecated cert utilities to keep tests scoped to deprecated APIs.
from codeflare_sdk.common.deprecated.utils.generate_cert import (
    export_env,
    generate_ca_cert,
    generate_tls_cert,
)
...
def test_generate_ca_cert():
    """
    test the function codeflare_sdk.common.deprecated.utils.generate_ca_cert generates the correct outputs
    """
...
def test_generate_tls_cert(mocker):
    ...
    mocker.patch(
        "codeflare_sdk.common.deprecated.utils.generate_cert.get_secret_name",
...
def test_export_env():
    """
    test the function codeflare_sdk.common.deprecated.utils.generate_ca_cert.export_ev generates the correct outputs
    """
    tls_dir = "cluster"
    ns = "namespace"
