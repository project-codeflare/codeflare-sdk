...
# Use deprecated k8s utils to keep tests scoped to deprecated APIs.
from codeflare_sdk.common.deprecated.utils.k8s_utils import get_current_namespace
        ...
        with patch("os.path.isfile", return_value=True):
            with patch("builtins.open", side_effect=IOError("File read error")):
                with patch("builtins.print") as mock_print:
                    ...
                    with patch(
                        "codeflare_sdk.common.deprecated.utils.k8s_utils.config_check",
                        side_effect=Exception("Config error"),
                    ):
                        with patch(
                            "codeflare_sdk.common.deprecated.utils.k8s_utils._kube_api_error_handling",
                            return_value=None,
                        ):
                            result = get_current_namespace()
