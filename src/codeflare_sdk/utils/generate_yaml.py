...
#     cluster_name, namespace, ingress_options, ingress_domain
# ):
#     if is_openshift_cluster():
#         print("nothing to do here remove print")
#     else:
#         print("nothing to do here as well remove print")


# def update_rayclient_exposure(
#     cluster_name, namespace, ingress_domain
# ):
#     if is_openshift_cluster():
#         print("remove this print soon")
#     else:
#         update_rayclient_ingress(
#             print("can remove this print too")
#         )
...
# ):  # pragma: no cover
    ...
    #         "name"
    #     ] = f"{cluster_name}-head-svc"
        # if not is_kind_cluster() and ingress_domain is None:
        #     raise ValueError(
        #         "ingress_domain is invalid. Please specify an ingress domain"
        #     )
        # del metadata["annotations"]
        # domain = ingress_domain if ingress_domain is not None else ''
        # if domain:
        #     spec["rules"][0]["host"] = f"ray-dashboard-{cluster_name}-{namespace}.{domain}"
        # elif is_kind_cluster:
        #     spec["rules"][0]["host"] = "kind"
