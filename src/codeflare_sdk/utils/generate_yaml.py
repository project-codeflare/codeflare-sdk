...
def head_worker_gpu_count_from_cluster(
    ...
    for k in cluster.config.head_extended_resource_requests.keys():
        resource_type = cluster.config.custom_resource_mapping[k]
...
def update_nodes(
    ...
    for comp in [head, worker]:
        ...
        if comp == head:
            ...
            update_resources(
                spec,
                cluster.config.min_cpus,
                cluster.config.max_cpus,
                cluster.config.min_memory,
                cluster.config.max_memory,
